...
class Media extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <Button variant="outlined" size="small" color="primary" onClick={this.handleClickOpen}>Dodaj Zdjęcie</Button>
                <Dialog
                    fullScreen
                                ...
                                <div className="uk-width-1-4">
                                    ...
                                    {selected ?
                                        <div className="selected">
                                            ...
                                            <div className="select uk-margin-bottom">
                                                <label className="uk-margin-small-bottom">Rozmiar</label>
                                                <Select
                                                    ...
                                                    name="size"
                                                >
                                                    <MenuItem value="url">Oryginalne</MenuItem>
                                                    <MenuItem value='large'>Duże(800x800)</MenuItem>
                                                    <MenuItem value='medium'>Średnie (400x400)</MenuItem>
                                                    <MenuItem value='thumb'>Małe(200x200)</MenuItem>
                                                    <MenuItem value='small_thumb'>Miniatura(100x100)</MenuItem>
                                                </Select>
                                            </div>
                                            <div>
